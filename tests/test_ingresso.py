...
class TestIngresso:
    ...
    def test_theaters_with_id(self, requests_mock, ingresso, theater):
    ...
    def test_theaters_city(self, requests_mock, ingresso, theaters_by_city):
    ...
    def test_sessions_by_theater(self, requests_mock, ingresso, sessions_by_theater):
